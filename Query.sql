...
insert into Producto values ('Arroz', 10, 'Arroz S.A')
insert into Producto values ('Frijol', 10, 'Frijol S.A')
insert into Producto values ('Papa', 10, 'Papa S.A')
insert into Producto values ('Leche', 10, 'Leche S.A')
insert into Producto values ('Huevos', 10, 'Huevos S.A')
insert into Producto values ('Cafe', 10, 'Cafe S.A')
insert into Producto values ('Azucar', 10, 'Azucar S.A')
insert into Producto values ('Sal', 10, 'Sal S.A')
insert into Producto values ('Aceite', 10, 'Aceite S.A')
insert into Producto values ('Carne', 10, 'Carne S.A')
insert into Producto values ('Pollo', 10, 'Pollo S.A')
insert into Producto values ('Pescado', 10, 'Pescado S.A')
insert into Producto values ('Pan', 10, 'Pan S.A')
insert into Producto values ('Galletas', 10, 'Galletas S.A')
insert into Producto values ('Jamon', 10, 'Jamon S.A')
insert into Producto values ('Queso', 10, 'Queso S.A')
insert into Producto values ('Cerveza', 10, 'Cerveza S.A')
insert into Producto values ('Vino', 10, 'Vino S.A')
insert into Producto values ('Cigarrillos', 10, 'Cigarrillos S.A')
insert into Producto values ('Cigarrillos', 10, 'Cigarrillos S.A')
